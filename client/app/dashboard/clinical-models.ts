...
export interface ClinicalModelConfig {
  ...
  anatomy: "brain" | "heart" | "blood" | "breast" | "metabolic" | "cardiacFailure" | "kidney" | "liver";
  scanLabel: string;
  patient: {
    id: string;
    age: number;
...
export const clinicalModels: Record<string, ClinicalModelConfig> = {
  ...
  kidneyDisease: {
    ...
    name: "Kidney Disease",
    category: "Nephrology",
    asset: "/clinical-kidney-twin.jpg",
    risk: 86,
    riskLevel: "HIGH",
    predictionStatus: "SEVERE CKD (STAGE 4)",
    probabilityLabel: "Prediction Probability",
    confidence: 88,
    anatomy: "kidney",
    scanLabel: "RENAL BIOMARKER FEATURES",
    patient: {
      id: "CKD-ASSESSMENT",
      age: 67,
      gender: "FEMALE",
      date: "08 SEP 2026",
      vitals: "eGFR 25 · SCr 4.2 mg/dL · BUN 62 · Albumin 3.2 g/dL",
    },
    primarySignal: {
      label: "Renal filtration signal",
      x: 0.50,
      y: 0.48,
    },
    factors: [
      {
        ...
        valueDisplay: "25 mL/min/1.73m\u00B2 (Severely Reduced / G4)",
        baselineDisplay: "Ref: \u2265 90 mL/min/1.73m\u00B2 (Normal)",
        description:
          "Primary determinant of CKD staging per KDIGO guidelines. eGFR reflects the filtration capacity of nephron mass and correlates inversely with CKD progression severity.",
      },
      {
        id: "serum_creatinine",
        ...
        y: 0.58,
        category: "Renal Function",
        valueDisplay: "4.2 mg/dL (Markedly elevated)",
        baselineDisplay: "Ref: 0.6 \u2013 1.2 mg/dL",
        description:
          "Waste product of creatine phosphate catabolism in muscle. Elevated serum creatinine reflects impaired glomerular filtration, rising inversely with declining renal function.",
      },
      {
        ...
        y: 0.38,
        category: "Renal Function",
        valueDisplay: "62 mg/dL (Uremic range)",
        baselineDisplay: "Ref: 7 \u2013 20 mg/dL",
        description:
          "Nitrogen component of urea — a metabolic byproduct of protein catabolism cleared by renal filtration. BUN elevation signals uremia and progressive nephron loss.",
      },
      {
        id: "urine_albumin",
        label: "Urine Albumin / ACR",
        contribution: 12,
        x: 0.42,
        y: 0.30,
        category: "Urine Markers",
        valueDisplay: "Albumin 310 mg/L \u00B7 ACR 380 mg/g (Macroalbuminuria)",
        baselineDisplay: "Ref: < 30 mg/L (Normoalbuminuria)",
        description:
          "Proteinuria is a hallmark of glomerular damage. Elevated urinary albumin excretion indicates disruption of the glomerular filtration barrier and accelerates CKD progression.",
      },
      {
        id: "hemoglobin",
        label: "Hemoglobin (Renal Anemia Signal)",
        contribution: 7,
        x: 0.58,
        y: 0.66,
        category: "Hematology",
        valueDisplay: "9.2 g/dL (Moderate-severe renal anemia)",
        baselineDisplay: "Ref: 12.0 \u2013 15.5 g/dL (Female)",
        description:
          "Declining erythropoietin production from damaged renal endocrine tissue causes normochromic normocytic anemia. Hemoglobin correlates inversely with CKD severity.",
      },
    ],
    aiReasoning:
      "Multi-class kidney disease classification model trained on 35 renal and systemic biomarker features from clinical CKD records. The prediction is based on eGFR-led staging (KDIGO criteria), with serum creatinine, BUN, and urinary albumin as supporting features. This assessment classifies the patient with SEVERE CKD (STAGE 4) based on the provided clinical inputs. Probability reflects model classification confidence across the 5-class prediction space (Healthy Kidney, Mild CKD Stage 1-2, Moderate CKD Stage 3, Severe CKD Stage 4, Kidney Failure Stage 5).",
    clinicalConsiderations: {
      priority: "High Priority — Severe CKD Stage 4 Signal",
      priorityLevel: "HIGH",
      factorsToReview: [
        "Repeat eGFR calculation using CKD-EPI 2021 creatinine equation for staging confirmation",
        "24-hour urine protein quantification and albumin-to-creatinine ratio (uACR) verification",
        "Complete metabolic panel: serum creatinine, BUN, sodium, potassium, calcium, phosphorus, bicarbonate",
        "Complete blood count to evaluate severity of renal anemia (CBC + reticulocyte count)",
        "Renal ultrasound for structural assessment (echogenicity, cortical thickness, obstruction)",
      ],
      followUpConsiderations: [
        "Urgent nephrology consultation for renal replacement therapy (dialysis/transplant) planning",
        "Erythropoiesis-stimulating agent (ESA) therapy evaluation for renal anemia management",
        "Phosphate binder initiation for hyperphosphatemia control",
        "Aggressive blood pressure management targeting < 130/80 mmHg",
        "Sodium bicarbonate supplementation for metabolic acidosis (bicarbonate < 22 mEq/L)",
      ],
      discussionPoints: [
        "Does the patient have vascular access planning underway for anticipated renal replacement therapy?",
        "What is the rate of eGFR decline over the past 6-12 months?",
        "Are RAAS inhibitors (ACEi or ARB) being used to slow CKD progression and reduce proteinuria?",
      ],
      disclaimer: "REQUIRES CLINICIAN REVIEW \u00B7 CLINICAL DECISION SUPPORT ONLY",
    },
    downstreamSignal: {
      title: "Nephrology Service Demand Signal",
      subtitle: "Aggregated CKD case load across Renal Clinic & Dialysis Access Center",
      metrics: [
        { label: "Nephrology referrals", change: "\u2191 21%", trend: "up", impact: "+6 consultation slots" },
        { label: "Dialysis access planning", change: "\u2191 14%", trend: "up", impact: "AV fistula creation queue" },
        { label: "Renal anemia clinic", change: "\u2191 18%", trend: "up", impact: "ESA protocol initiation" },
      ],
      actionLabel: "VIEW IN HOSPITAL INTELLIGENCE →",
    },
  },
  liverDisease: {
    id: "liverDisease",
    name: "Liver Disease Screening & Hepatic Risk",
    category: "Hepatology / Gastroenterology",
    asset: "/clinical-liver-twin.jpg",
    risk: 76,
    riskLevel: "HIGH",
    predictionStatus: "HEPATIC IMPAIRMENT DETECTED",
    probabilityLabel: "Liver Disease Probability",
    confidence: 84,
    anatomy: "liver",
    scanLabel: "Hepatic Panel Telemetry (ILPD Protocol)",
    patient: {
      id: "PAT-008-LVR",
      age: 47,
      gender: "Male",
      date: "08 Sep 2026",
      vitals: "BP 132/84 · Bilirubin 4.2 · ALT 88 · AST 120",
    },
    primarySignal: {
      label: "Hepatic Parenchymal & Biliary Stress Zone",
      x: 0.52,
      y: 0.46,
    },
    factors: [
      {
        ...
        x: 0.52,
        y: 0.38,
        category: "Biliary Clearance",
        valueDisplay: "4.2 mg/dL",
        baselineDisplay: "0.2 - 1.2 mg/dL",
        description: "Markedly elevated serum total bilirubin indicates impaired hepatic clearance or biliary ductal stasis.",
      },
      {
        id: "lvr-transaminases",
        label: "AST / ALT Ratio & Transaminases",
        contribution: 24,
        x: 0.44,
        y: 0.48,
        category: "Hepatocellular Necrosis",
        valueDisplay: "ALT: 88, AST: 120 IU/L",
        baselineDisplay: "ALT < 45, AST < 40 IU/L",
        description: "Transaminase elevation with AST > ALT elevation points to acute hepatocellular injury, toxic or alcohol-associated stress.",
      },
      {
        id: "lvr-alkphos",
        ...
        x: 0.58,
        y: 0.45,
        category: "Cholestatic Marker",
        valueDisplay: "280 IU/L",
        baselineDisplay: "44 - 147 IU/L",
        description: "Elevated ALP indicates cholestasis, bile duct inflammation, or infiltrative liver disorder.",
      },
      {
        id: "lvr-albumin",
        label: "Albumin & A/G Ratio",
        contribution: -14,
        x: 0.48,
        y: 0.62,
        category: "Synthetic Function",
        valueDisplay: "Albumin 2.8 g/dL (A/G 0.7)",
        baselineDisplay: "Albumin 3.5 - 5.5 g/dL (A/G > 1.0)",
        description: "Hypoalbuminemia and inverted albumin/globulin ratio indicate impaired hepatic synthetic reserve.",
      },
      {
        id: "lvr-proteins",
        label: "Total Protein & Globulins",
        contribution: 12,
        x: 0.56,
        y: 0.58,
        category: "Protein Profile",
        valueDisplay: "6.2 g/dL",
        baselineDisplay: "6.0 - 8.3 g/dL",
        description: "Low-normal total protein with disproportionately elevated globulin fraction reflecting chronic inflammatory response.",
      },
    ],
    aiReasoning:
      "Logistic regression model (ILPD cohort) detected high probability of acute/chronic hepatic disease (76%) based on significant transaminasemia (AST 120, ALT 88), conjugated hyperbilirubinemia (4.2 mg/dL), and impaired synthetic function (Albumin 2.8 g/dL). Findings warrant urgent abdominal ultrasonography and hepatology evaluation.",
    clinicalConsiderations: {
      priority: "High Priority — Acute / Chronic Hepatic Impairment",
      priorityLevel: "HIGH",
      factorsToReview: [
        "Fractionated bilirubin (Direct vs. Indirect) and serial LFT trending over 48 hours",
        "Abdominal right upper quadrant ultrasound to evaluate liver parenchyma, portal vein patency, and biliary dilation",
        "Coagulation panel (PT/INR) to assess acute synthetic hepatic function",
        "Viral hepatitis serologies (HBsAg, anti-HCV, anti-HAV IgM) and autoimmune liver antibodies (ANA, ASMA)",
        "Toxicology screen and comprehensive review of prescription/OTC medications and alcohol history",
      ],
      followUpConsiderations: [
        "Urgent Gastroenterology / Hepatology specialty consult",
        "Immediate cessation of all hepatotoxic medications (NSAIDs, acetaminophen, statins pending review)",
        "Nutritional support with sodium restriction if early ascites or peripheral edema is noted",
        "Surveillance for signs of hepatic encephalopathy (asterixis, mental status changes)",
      ],
      discussionPoints: [
        "Is there a history of chronic alcohol consumption or risk factors for viral hepatitis?",
        "Has the patient had recent exposure to new prescription medications, herbal supplements, or mushroom toxins?",
        "What is the baseline liver ultrasound appearance (steatosis vs. nodularity vs. biliary stones)?",
      ],
      disclaimer: "REQUIRES CLINICIAN REVIEW · CLINICAL DECISION SUPPORT ONLY",
    },
    downstreamSignal: {
      title: "Hepatology & GI Inpatient Demand",
      subtitle: "Aggregated liver disorder admissions across Digestive Disease Unit",
      metrics: [
        { label: "GI Endoscopy referrals", change: "↑ 16%", trend: "up", impact: "+4 procedure slots" },
        { label: "Abdominal Ultrasound queue", change: "↑ 22%", trend: "up", impact: "Hepatic Doppler backlog" },
        { label: "Hepatology consult volume", change: "↑ 19%", trend: "up", impact: "Outpatient clinic load" },
      ],
      actionLabel: "VIEW IN HOSPITAL INTELLIGENCE →",
    },
  },
